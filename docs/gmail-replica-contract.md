...
Embedding backfill and initial Memory wait for the watch-first sequence to complete. Thread-label work starts after discovery identifies every Gmail message/thread relationship and then proceeds in parallel as complete threads finish storing:
